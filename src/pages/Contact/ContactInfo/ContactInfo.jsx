    ...
    <div>
      <div className="px-4 md:px-10 py-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <hr className="mb-6" />
          <p className="text-gray-600 mt-2">Innovative & Sustainable Solutions...</p>
        </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                76, DIT Road, A.M.Plaza (1st Floor), S# 204,<br />
                Malibagh, Dhaka-1217, Bangladesh
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          <iframe
            ...
            src="https://www.google.com/maps?q=Malibagh+DIT+Road+Dhaka+Bangladesh&output=embed"
            allowFullScreen=""
            loading="lazy"
